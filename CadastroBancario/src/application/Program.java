...
public class Program {
	...
	public static void main(String[] args) {
		...
		Conta conta;
        // usado somente print pra não ter quebra de linha e escrever o dado na squencia e não na proxima linha.
		System.out.print("Enter account number: ");
		int numConta = sc.nextInt();
		System.out.print("Enter account holder: ");
		// sempre que usar nextLine após um nextInt colocar um (sc.nextLine) para consumir uma linha.
		sc.nextLine();
